  ...
  return (
    <div className="animate-fade-in py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
        <button
          onClick={onBack}
          className="group inline-flex items-center gap-2 px-4 py-2 rounded-xl text-slate-700 hover:text-blue-600 bg-white hover:bg-slate-50 border border-slate-200 shadow-sm transition-all text-xs sm:text-sm font-semibold"
        >
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 bg-white border border-slate-200 px-3 py-1.5 rounded-xl shadow-sm">
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Workspace Card */}
        <div className={`w-full ${maxWidth} bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-sm transition-all`}>
          {children}
        </div>

        {/* Trust Badges under Spoke (Section 4.4) */}
        <div className="flex flex-wrap items-center justify-center gap-6 mt-6 text-xs font-medium text-slate-500 select-none">
