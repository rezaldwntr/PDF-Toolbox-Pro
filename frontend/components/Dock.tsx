...
const Dock: React.FC<DockProps> = ({ activeWindows, focusedWindow, onOpenWindow }) => {
  ...
  return (
    <div className="fixed bottom-2 lg:bottom-4 left-0 right-0 flex justify-center z-[9000] pointer-events-none px-2">
      <div className="bg-[#1a1a1a]/40 backdrop-blur-xl border border-white/10 rounded-[20px] lg:rounded-[28px] p-2 lg:p-[10px] flex items-end gap-2 lg:gap-3 shadow-2xl h-[56px] lg:h-[76px] pointer-events-auto max-w-full">
        {dockItems.map((item) => {
